...
//#cgo linux,arm,!android LDFLAGS: deliberately breaking arguments here -L/opt/vc/lib -L/opt/vc/lib64 -lSDL2_linux_arm -Wl,-unresolved-symbols=ignore-all -lm -ldl -liconv -lbcm_host -lvcos -lvchiq_arm -pthread
import "C"
